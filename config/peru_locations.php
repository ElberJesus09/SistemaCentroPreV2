...
return [
    ...
    'Arequipa' => [
        ...
        'La Uniòn' => ['Cotahuasi', 'Alca', 'Charcana', 'Huaynacotas', 'Pampamarca', 'Puyca', 'Quechualla', 'Sayla', 'Tauria', 'Tomepampa', 'Toro'],
    ],
    'Ayacucho' => [
        ...
        'Pàucar del Sara Sara' => ['Pausa', 'Colta', 'Corculla', 'Lampa', 'Marcabamba', 'Oyolo', 'Pararca', 'San Javier de Alpabamba', 'San José de Ushua', 'Sara Sara'],
        ...
        'Vilcas Huamán' => ['Vilcas Huaman', 'Accomarca', 'Carhuanca', 'Concepción', 'Huambalpa', 'Independencia', 'Saurama', 'Vischongo'],
    ],
    'Cajamarca' => [
    ...
    'Cusco' => [
        ...
        'Paruro' => ['Paruro', 'Accha', 'Ccapi', 'Colcha', 'Huanoquite', 'Omachaç', 'Paccaritambo', 'Pillpinto', 'Yaurisque'],
    ...
    'Huancavelica' => [
        ...
        'Huaytará' => ['Huaytara', 'Ayavi', 'Córdova', 'Huayacundo Arma', 'Laramarca', 'Ocoyo', 'Pilpichaca', 'Querco', 'Quito-Arma', 'San Antonio de Cusicancha', 'San Francisco de Sangayaico', 'San Isidro', 'Santiago de Chocorvos', 'Santiago de Quirahuara', 'Santo Domingo de Capillas', 'Tambo'],
    ...
    'Huánuco' => [
        'Huánuco' => ['Huanuco', 'Amarilis', 'Chinchao', 'Churubamba', 'Margos', 'Quisqui (Kichki)', 'San Francisco de Cayran', 'San Pedro de Chaulan', 'Santa María del Valle', 'Yarumayo', 'Pillco Marca', 'Yacus', 'San Pablo de Pillao'],
